...
meshtastic --set device.role CLIENT --set device.node_info_broadcast_secs 3600
meshtastic --set-owner '38LBUILM8ClN F4HVVGrandRatz⛰️Gaulix' --set-owner-short Ratz
meshtastic --set lora.region EU_868 --set lora.modem_preset LONG_MODERATE --set lora.tx_power 22 --set lora.ignore_mqtt true --set lora.sx126x_rx_boosted_gain true --set lora.override_frequency 869.4625
...
meshtastic --set neighbor_info.enabled true --set neighbor_info.update_interval 3600
